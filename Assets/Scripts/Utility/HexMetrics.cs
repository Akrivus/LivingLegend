...
public static class HexMetrics
{
	...
	/// </summary>
	public const float elevationStep = 3.3f;
	...
	/// </summary>
	public const float cellPerturbStrength = 4.4f;
	...
	/// </summary>
	public const float streamBedElevationOffset = -1.1f;

	/// <summary>
	/// Offset for water elevation.
	/// </summary>
	public const float waterElevationOffset = -0.1f;
